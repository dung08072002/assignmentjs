    ...
    async render() {
        ...
        <div class="home_content_2">
            <div class="container_home_content">
                ...
                <div class="add">
                    <a href="/admin/products/add" class="text_uppercase add-user un_select">add new product <i class="fas fa-plus"></i></a>
                </div>
                <div class="users_table">
                    <table class="styled-table">
                        <thead>
                            ...
                            <th class="text_cap">product price</th>
                            <th class="text_cap">product status</th>
